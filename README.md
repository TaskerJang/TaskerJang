I'm a specialized ML Engineer with proven expertise in **AI-driven production systems**, focusing on end-to-end machine learning pipelines from **advanced RAG architectures** and **generative AI services** to **financial analysis agents**. With strong proficiency in **Python**, **Java**, and **Rust**, I've successfully contributed to **open-source ML frameworks**, **Korean AI evaluation benchmarks**, and **sector analysis systems** that demonstrate both my technical depth and collaborative capabilities in solving complex AI challenges.
